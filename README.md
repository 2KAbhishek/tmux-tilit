...
<kbd>Alt</kbd> is the default `tilit-mod` key, these bindings will change if you are changing it or using `tilit-prefix`.
...
| <kbd>Alt</kbd> + <kbd>N</kbd>            | Search notes [tdo][1]    |
...
| <kbd>Alt</kbd> + <kbd>R</kbd>            | Rotate window            |
